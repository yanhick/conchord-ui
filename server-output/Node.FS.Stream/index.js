...
var Node_FS_Perms_1 = require("../Node.FS.Perms");
var Node_FS_Perms_1 = require("../Node.FS.Perms");
...
var readWrite = (function () {
    var rw = Data_Semiring.add(Node_FS_Perms_1.semiringPerm)(Node_FS_Perms_1.read)(Node_FS_Perms_1.write);
    return Node_FS_Perms_1.mkPerms(rw)(rw)(rw);
})();
    ...
    return function (fd) {
        return Data_Function.apply(Node_FS_Internal.mkEff)(function (v) {
            return fs.createWriteStream($$null, {
                fd: fd, 
                mode: Node_FS_Perms_1.permsToInt(opts.perms), 
