...
var link = function (src) {
    return function (dst) {
        return function (cb) {
            return Data_Function.apply(Node_FS_Internal.mkEff)(function (v) {
...
var mkdir = Data_Function.apply(Data_Function.flip(mkdir$prime))(Node_FS_Perms.mkPerms(Node_FS_Perms.all)(Node_FS_Perms.all)(Node_FS_Perms.all));
...
var stat = function (file) {
    return function (cb) {
        return Data_Function.apply(Node_FS_Internal.mkEff)(function (v) {
            return fs.stat(file, Data_Function.apply(handleCallback)(function ($58) {
...
var utimes = function (file) {
    return function (atime) {
        return function (mtime) {
            return function (cb) {
                var toEpochMilliseconds = function ($59) {
                    return Data_DateTime_Instant.unInstant(Data_DateTime_Instant.fromDateTime($59));
                };
                var ms = function (v) {
...
var exists = function (file) {
    return function (cb) {
        return Data_Function.apply(Node_FS_Internal.mkEff)(function (v) {
            return Data_Function.apply(Data_Function_Uncurried.runFn2(fs.exists)(file))(function (b) {
