        ...
        return function (enc) {
            return function __do() {
                ...
                if (v instanceof Data_Maybe.Just && v.value0 instanceof Data_Either.Right) {
                    return Data_Functor.map(Control_Monad_Eff.functorEff)(Data_Maybe.Just.create)(Data_Function.apply(Control_Monad_Eff_Unsafe.unsafeInterleaveEff)(Node_Buffer_1.toString(enc)(v.value0.value0)))();
                };
                throw new Error("Failed pattern match at Node.Stream line 118, column 3 - line 121, column 84: " + [ v.constructor.name ]);
            };
        };
    };
};
    ...
    return function (enc) {
        return function (cb) {
            return onData(r)(Control_Bind.composeKleisliFlipped(Control_Monad_Eff.bindEff)(cb)(function ($17) {
                return Control_Monad_Eff_Unsafe.unsafeInterleaveEff(Node_Buffer_1.toString(enc)($17));
            }));
        };
    };
};
