...
var permsToInt = Data_Function.apply(Partial_Unsafe.unsafePartial)(function (dictPartial) {
    return function ($97) {
...
var showPerms = new Data_Show.Show(function (v) {
    var f = function (perm) {
        ...
        var $92 = Data_Function.apply(Data_Maybe.isNothing)(Data_String.indexOf(" ")(str));
        if ($92) {
            return str;
        };
        if (!$92) {
