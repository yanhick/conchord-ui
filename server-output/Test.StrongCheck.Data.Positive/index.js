...
var eqPositive = new Data_Eq.Eq(function (x) {
    return function (y) {
        return x === y;
    };
});
var ordPositive = new Data_Ord.Ord(function () {
    return eqPositive;
}, function (x) {
    return function (y) {
...
var coarbPositive = new Test_StrongCheck_Arbitrary.Coarbitrary(function (v) {
    return Test_StrongCheck_Arbitrary.coarbitrary(Test_StrongCheck_Arbitrary.coarbNumber)(v);
});
var arbPositive = new Test_StrongCheck_Arbitrary.Arbitrary(Data_Functor.map(Test_StrongCheck_Gen.functorGenT(Control_Monad_Free.freeMonad))(Data_Functor.map(Data_Functor.functorFn)(Positive)(function (v) {
    return v * maxNumber;
}))(Test_StrongCheck_Gen.uniform(Control_Monad_Free.freeMonad)));
module.exports = {
    Positive: Positive, 
    runPositive: runPositive, 
    eqPositive: eqPositive, 
    ordPositive: ordPositive, 
