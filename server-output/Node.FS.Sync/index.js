...
var stat = function (file) {
    return Data_Function.apply(Data_Functor.map(Control_Monad_Eff.functorEff)(Node_FS_Stats.Stats.create))(Data_Function.apply(Node_FS_Internal.mkEff)(function (v) {
